...
ret_paths = "/home/mingrui/difftaichi/difftaichi2/saved_results/sim_config_DiffPhy_robot2_vhc_5_l01_landscape/DiffTaichi_DiffPhy/0916_162746/validation/summary.csv"
...
print(ret)
losses = ret.loc["velocity"].values
print(losses)
one_way_sample_points = 50
heatmap = losses.copy().astype("float").reshape([one_way_sample_points * 2 + 1, -1])
print(heatmap.shape)
sns.heatmap(heatmap)
